...
//    // entity/table containing details regarding volume, weight, duration, sets of exercises, etc.!!!!!!!!!!!!!!!!!!!!!!
//    @ManyToOne
//    @JoinColumn(name = "workout_volume_id")
//    private WorkoutVolume workoutVolume;
